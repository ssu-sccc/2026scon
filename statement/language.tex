...
\begin{itemize}[noitemsep]
    ...
    \item 채점은 Vultr Optimized Cloud Compute 인스턴스(voc-c-8c-16gb-150s)에서 진행됩니다.
    \item 채점 서버의 운영체제는 Ubuntu 24.04 LTS x64 입니다.
    \item 아래 언어 중 원하는 언어를 선택해 사용할 수 있습니다.
    
    \begin{itemize}[noitemsep,topsep=0pt]
        \item C11: \texttt{gcc (Ubuntu 13.3.0-6ubuntu2~24.04.1) 13.3.0} % \\
        % 컴파일: \texttt{gcc Main.c -o Main -O2 -Wall -lm -static -std=gnu11}\\\texttt{-DONLINE\_JUDGE -DBOJ}\\
        % 실행: \texttt{./Main}
        \item C++17: \texttt{g++ (Ubuntu 13.3.0-6ubuntu2~24.04.1) 13.3.0} % \\
        % 컴파일: \texttt{g++ Main.cc -o Main -O2 -Wall -lm -static -std=gnu++17}\\\texttt{-DONLINE\_JUDGE -DBOJ}\\
        % 실행: \texttt{./Main}
        \item Java 21: \texttt{openjdk version "21.0.10" 2026-01-20} % \\
